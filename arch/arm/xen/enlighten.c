...
EXPORT_SYMBOL_GPL(HYPERVISOR_freeze_op);
EXPORT_SYMBOL_GPL(HYPERVISOR_prepare_photo_op);
EXPORT_SYMBOL_GPL(HYPERVISOR_unfreeze_op);
EXPORT_SYMBOL_GPL(HYPERVISOR_show_photo_op);
